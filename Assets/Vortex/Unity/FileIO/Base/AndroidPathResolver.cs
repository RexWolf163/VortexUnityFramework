...
namespace Vortex.Core.FileSystem.Android
{
    /// <summary>
    ...
    public static class AndroidPathResolver
    {
        ...
        public static string GetAndroidPath()
        {
            ...
            var externalStorageDirectory = environmentClass.CallStatic<AndroidJavaObject>("getExternalStoragePublicDirectory", "Download");

...
namespace Articy.Sf_Novel.Templates
{
    ...
    [Serializable()]
    public class LocationDataTemplate : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Sf_Novel.Templates.LocationDataTemplate newClone = ((Articy.Sf_Novel.Templates.LocationDataTemplate)(aClone));
            if ((Narrative != null))
            {
        ...
        {
            Articy.Sf_Novel.Templates.LocationDataTemplate clone = new Articy.Sf_Novel.Templates.LocationDataTemplate();

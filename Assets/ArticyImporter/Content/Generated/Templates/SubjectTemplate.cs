...
namespace Articy.Sf_Novel.Templates
{
    ...
    [Serializable()]
    public class SubjectTemplate : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Sf_Novel.Templates.SubjectTemplate newClone = ((Articy.Sf_Novel.Templates.SubjectTemplate)(aClone));
            if ((Narrative != null))
            {
        ...
        {
            Articy.Sf_Novel.Templates.SubjectTemplate clone = new Articy.Sf_Novel.Templates.SubjectTemplate();
